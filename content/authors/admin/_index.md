...
profiles:
  - icon: at-symbol
    url: 'mailto:xingyu.zhu@princeton.edu'
    label: E-mail Me
  - icon: brands/x
    url: https://x.com/XingyuZhu_
  - icon: brands/github
    url: https://github.com/UltimateJupiter
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?user=Dlya3HMAAAAJ&hl=en
  - icon: academicons/orcid
    url: https://orcid.org/0000-0003-1997-4668
